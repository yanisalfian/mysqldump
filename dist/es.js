import { appendFileSync, createWriteStream, unlinkSync, writeFileSync } from 'fs';
...
function compress7z(filename, password) {
    return new Promise((resolve, reject) => {
        const pathTo7zip = path7za;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (options.dump.function !== false) {
                const functions = yield getFunctionDump(connection, options.connection.database, options.dump.function);
            ...
            if (options.dumpToFile && res.dump.function) {
                appendFileSync(options.dumpToFile, `${res.dump.function}\n\n`);
            }
